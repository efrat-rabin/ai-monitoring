...
# Add libs for CursorClient, github_api, code_block
sys.path.insert(0, str(Path(__file__).parent.parent.parent / "libs"))
# Same dir for github_comment_utils and prompts
sys.path.insert(0, str(Path(__file__).parent))

from cursor_client import CursorClient
import github_api
from code_block import extract_code_block
from github_comment_utils import extract_issue_data_from_comment, get_root_comment
...
def _extract_yaml_from_response(response: str) -> str:
    ...
    result = extract_code_block(response, "yaml")
...
_Generated by AI automation 🤖_"""

    resp = github_api.post_pr_review_comment(
        github_token, repository, pr_number, comment_body, in_reply_to=comment_id
    )
...
def _post_error_comment(
    ...
    body = "⚠️ **Monitor generation failed**\n\n" + message + "\n\n_AI automation 🤖_"
    resp = github_api.post_pr_review_comment(
...
def main() -> int:
    ...
    try:
        ...
        print("✓ Monitor YAML generated and comment posted")
        return 0
